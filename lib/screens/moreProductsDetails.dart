    ...
    IconButton(onPressed: (){}, icon: const Icon(Icons.shopping_cart),)
      ...
      body: Stack(children: [
        Container(
          ...
          child: Image.network("https://media.istockphoto.com/photos/multicolored-fresh-fruits-on-white-background-picture-id1314537818?b=1&k=20&m=1314537818&s=612x612&w=0&h=GfKdnYJuNtU7LfEdZCPwYblqmNxBFqr1tSjxcuCDKVU=",fit: BoxFit.cover,),),
        ...
        child: BackdropFilter(
          ...
          padding: const EdgeInsets.symmetric(vertical: 20,horizontal: 10),
            decoration: BoxDecoration(
              border: Border.all(color: Colors.white,style: BorderStyle.solid,width: .7),
            color: Color.fromARGB(255, 192, 192, 192).withOpacity(0.4),
          // color: Colors.white,
            borderRadius: BorderRadius.circular(12)),
            child: Column(
            children: [
